...
CREATE TABLE IF NOT EXISTS `abonati` (
  ...
  `Clasa` tinyint(4) DEFAULT NULL,
  `Data_abonarii` date DEFAULT NULL,
  UNIQUE KEY `Cod_abonat` (`Cod_abonat`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Dumping data for table biblioteca.abonati: ~0 rows (approximately)
...
INSERT INTO `citate` (`Numar`, `Citate`) VALUES
	...
	(4, 'Cărţile sunt un refugiu, un fel de refugiu monahal, faţă de vulgarităţile lumii reale. Walter Pater'),
	(5, 'Cei înţelepţi sunt întotdeauna deasupra cărţilor. Samuel Daniel'),
	(6, 'Nu există cărţi morale sau cărţi imorale. Cărţile sunt bine scrise sau prost scrise. Asta e totul. Oscar Wilde'),
	(7, 'Cărţile te vindecă de oameni, iar oamenii de cărţi. Vladimir Ghika'),
	(8, 'Nimic nu este mai bun decât să aprinzi pofta şi iubirea de carte; altfel nu creşti decât măgari încărcaţi cu cărţi. Michel de Montaigne'),
